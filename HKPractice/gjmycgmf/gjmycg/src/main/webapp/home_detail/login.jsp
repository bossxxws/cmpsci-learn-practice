        ...
        <form  class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 fom row">
                    ...
                    <div class="col-sm-10"><input type="text" autocomplete="off"  name="user" id="user" placeholder="请输入用户名称" value = "bbbbbb"></div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9 fom row">
                    ...
                    <div class="col-sm-10"><input type="password" id="password"  name="password" placeholder="设置6到20位登录密码" value="bbbbbb"></div>
                </div>
            </div>
            <div class="form-group row">
